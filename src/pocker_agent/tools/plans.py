...
def plan_for_rules(rules: Any) -> dict[str, Any]:
    ...
    if kind == "blackjack":
        ...
        from ..flow_plans.holdem import holdem_plan
        return holdem_plan(rules)
    elif kind == "doudizhu":
        ...
        base["tools"] = [{"name": "deck", "config": {"ranks": deck.ranks, "suits": deck.suits}},
                          {"name": "zones"}, {"name": "draw_discard"}, {"name": "draw_until_playable", "config": {"recycle": rules.recycle_discard, "wild_ranks": [rules.wild_rank] if rules.wild_rank else []}},
        ...
        base["flow"] = {"entry": "deal", "initial": {"finished": False, "winners": [], "current_player": 0, "phase": "play"}, "nodes": {
            ...
            "wait": {"kind": "wait", "inputs": {"play": "turn", "draw": "draw_policy", "pass": "turn"}},
            "draw_policy": {"kind": "call", "next": "branch", "action": {"tool": "shedding_turn", "operation": "draw_until_playable", "args": {"state": "$state"}, "result_key": "turn_result"}},
