...
def simulate(rules: GameRuleDSL, seed: int = 0, player_count: int | None = None, max_steps: int = 1000) -> SimulationResult:
    engine = RuleEngine(rules, seed=seed, player_count=player_count)
